...
<body>
    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            ...
            //SQL query with status condition
            $query = "SELECT * FROM complaint WHERE complaint_status = '$selectedStatus'"
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>" . $Udesc . "</td>";
                    echo "<td>";
                    echo "<a href='AdminUpdateComplaintStatus.php?id=" . $cID . "'>Ubah</a> ";
                    echo "</td>";
                    echo "</tr>";
                }
                echo "</table>";
            ...
            <br><br>
            <div align="center">
                <form method="GET" action="AdminViewComplaintList.php">
