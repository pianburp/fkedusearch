  ...
  <body>
    ...
    <div class="wrapper d-flex align-items-stretch">
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        <h2 class="mb-4" style="font-weight: bold;">Update Expert's Status</h2>
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Expert Details</h5>
            <form action="updateExpert2.php" method="post" class="row g-3">
              <div class="col-md-12">
                <label for="inputName5" class="form-label">Expert's Name</label>
                <input type="text" class="form-control" name="name" value="<?php echo $row['name_expert']; ?>" readonly></input>
              </div>
              <div class="col-md-6">
                <label for="inputEmail5" class="form-label">Expert's Email</label>
                <input type="email" class="form-control" name="email" value="<?php echo $row['email_expert']; ?>" readonly></input>
              </div>
              <div class="col-md-4">
                <label for="inputState" class="form-label">Expert's Status</label>
                <select id="inputState" class="form-select" name="status">
                  <option selected>Choose...</option>
                  <option>Unvalidate</option>
                  <option>Validate</option>
                </select>
              </div>
              <div><input type="number" name="id" value="<?php echo $row['id']; ?>" hidden>
              </div>
