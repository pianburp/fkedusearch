...
<body>
  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5 pt-5">
      <h2 class="mb-4" style="font-weight: bold;">Expert Validation</h2>
        ...
        <div class="card-body">
          ...
          <table class="table table-hover">
            ...
            <tbody>
              <tr>
                <?php
                $query = "SELECT `id`, `name_expert`, `email_expert`, `status_expert` FROM expert";
                $result = mysqli_query($conn, $query); ?>
                <?php while ($row = $result->fetch_array()) { ?>
                  <td><?php echo $row['id']; ?> </td>
                  <td><?php echo $row['name_expert']; ?> </td>
                  <td><?php echo $row['email_expert']; ?> </td>
                  <td><?php echo $row['status_expert']; ?> </td>
                  <td>
                    <form action="updateExpert.php" method="post"><input type="number" name="id" value="<?php echo $row['id']; ?>" hidden><input type="submit" class="btn btn-primary" value="Update"></form>
                  </td>
              </tr>
            <?php } ?>
            </tbody>
