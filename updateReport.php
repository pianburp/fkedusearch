  ...
  <body>
    ...
    <div class="wrapper d-flex align-items-stretch">
      ...
      <div id="content" class="p-4 p-md-5 pt-5">
        <h2 class="mb-4" style="font-weight: bold;">Update Report's Status</h2>
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Report Details</h5>
            <form action="updateReport2.php" method="post" class="row g-3">
              <div class="col-md-12">
                <label for="inputName5" class="form-label">Report's Title</label>
                <input type="text" class="form-control" name="title" value="<?php echo $row['title_report']; ?>" readonly></input>
              </div>
              <div class="col-md-6">
                <label for="inputEmail5" class="form-label">Report's Description</label>
                <input type="email" class="form-control" name="desc" value="<?php echo $row['desc_report']; ?>" readonly></input>
              </div>
              <div class="col-md-4">
                <label for="inputState" class="form-label">Report's Status</label>
